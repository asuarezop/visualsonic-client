...
//     function songLoaded(loadedSong: number) {
//       // song = loadedSong;
...
//       //   console.log('Howler.js is using the Web Audio API.');
//       //   console.log('AudioContext:', Howler.ctx);
//       // } else {
//       //   console.log('Howler.js is using HTML5 Audio.');
//       // }
//       // if (!audioCtx) {
...
//       // }
//       // //If an existing MediaElementAudioSource is connected
//       // if (source) {
//       //   source.disconnect();
//       // } else {
//       //   audioElement = document.getElementById(
